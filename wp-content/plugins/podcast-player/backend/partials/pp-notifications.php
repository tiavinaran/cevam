...
<div class="updated notice is-dismissible pp-welcome-notice">
	...
	<ol>
	<li class="premium">
		<?php esc_html_e( 'Removed Mediaelement JS library for Audio podcasts.', 'podcast-player' ); ?>
	</li>
	<li class="premium">
		<?php esc_html_e( 'Added cron job to update podcast episodes. Help to resolve auto podcast updates with caching plugins.', 'podcast-player' ); ?>
	</li>
	<li class="premium">
		<?php esc_html_e( 'Compatibility check with WordPress 6.4', 'podcast-player' ); ?>
	</li>
	<li class="premium">
		<?php esc_html_e( 'Update twitter icon.', 'podcast-player' ); ?>
	</li>
	</ol>
